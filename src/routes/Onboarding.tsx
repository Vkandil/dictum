...
export default function Onboarding({ initial, platform, devices = [], hasOpenRouterKey = false, onComplete }: OnboardingProps) {
  ...
  const captureShortcut = (event: ReactKeyboardEvent<HTMLButtonElement>) => {
    ...
    const captured = shortcutFromKeyEvent(event.nativeEvent, isMac);
