  ...
  return <div className="page">
    ...
    <div className="settings-stack">
      ...
      <Card><div className="setting-heading"><ShieldCheck /><div><h2>Privacy & lifecycle</h2><p>Audio is never persisted. Text history is optional.</p></div></div>
        ...
        <Toggle checked={settings.autostart} onChange={(value) => patch("autostart", value)} label="Launch at login" description="Keep Dictum ready in the system tray." />
      </Card>
