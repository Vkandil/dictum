...
export default function Dictionary({ terms, reload, liveMode }: { terms: DictionaryTerm[]; reload: () => Promise<void>; liveMode: boolean }) {
  ...
  return <div className="page">
    ...
    {liveMode ? <LiveModeNotice feature="Dictionary terms" /> : null}
